	        ...
	        <div class="col-md-12">
	          	<div class="card">
		            <div class="card-header">
		              <a href="{{route('main-categories.create')}}" class="btn btn-primary btn-sm">
		              <i class="fa fa-plus"></i> add main category</a>
		            </div>
		            <!-- /.card-header -->
		            <div class="card-body">
			            <table id="example2" class="table table-bordered table-strip">
			                ...
			                <tbody>
			                	...
			                	<tr>
				                	...
				                	<td>
				                		<form action="{{route('main-categories.destroy', $val->id)}}" method="post" onclick="return confirm('Do you want to delete this item?')">
				                			@csrf
				                			@method('delete')
									  ...
									  <div class="modal-dialog" role="document">
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="{{route('main-categories.update', $val)}}" method="POST">
							                  @csrf
							                  @method('PATCH')
							                  <div class="card-body">
