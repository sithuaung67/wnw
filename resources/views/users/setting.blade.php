        ...
        <section class="content" style=" padding-bottom: 100%;">
            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="text-center">
                    <span class="logo-lg"><img src="{{URL::to('image/tour4.jpeg')}}" class="img-bordered-sm img-thumbnail" style="width: 100% ;height: auto"></span>
                </div>
                <br>
                <ul class="list-group">
                    <li class="list-group-item">Full Name : <span class="text-primary">{{Auth::User()->name}}</span></li>
                    <li class="list-group-item">Username : <span class="text-primary">{{Auth::User()->email}}</span></li>
